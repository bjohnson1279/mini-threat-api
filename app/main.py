...
# ⚡ Bolt Optimization: Add GZipMiddleware to compress large JSON responses
...
def list_iocs(
    ...
    # ⚡ Bolt Optimization: Added offset pagination
    # Adding an offset parameter alongside limit allows clients to effectively paginate
    # through large sets of threat intelligence indicators without downloading everything.
